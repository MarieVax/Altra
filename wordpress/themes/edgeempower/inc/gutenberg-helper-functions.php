...
function generateElementStyles($elementType, $id, $target) {
  ...
  if(
    $spacingMode == 'simple' &&
    (
      (!empty($spacingArray['margin_top']) && strlen( $spacingArray['margin_top'] ) != 0  && is_numeric($spacingArray['margin_top'])) ||
      (!empty($spacingArray['margin_right']) && strlen( $spacingArray['margin_right'] ) != 0 && is_numeric($spacingArray['margin_right']))||
      (!empty($spacingArray['margin_bottom']) && strlen( $spacingArray['margin_bottom'] ) != 0 && is_numeric($spacingArray['margin_bottom'])) ||
      (!empty($spacingArray['margin_left']) && strlen( $spacingArray['margin_left'] ) != 0 && is_numeric($spacingArray['margin_left'])) ||
      (!empty($spacingArray['padding_right']) && strlen( $spacingArray['padding_right'] ) != 0 && is_numeric($spacingArray['padding_right'])) ||
      (!empty($spacingArray['padding_bottom']) && strlen( $spacingArray['padding_bottom'] ) != 0 && is_numeric($spacingArray['padding_bottom'])) ||
      (!empty($spacingArray['padding_left']) && strlen( $spacingArray['padding_left'] ) != 0 && is_numeric($spacingArray['padding_left'])) ||
      (!empty($spacingArray['padding_top']) && strlen( $spacingArray['padding_top'] ) != 0 && is_numeric($spacingArray['padding_top']))
    )
  ) {
