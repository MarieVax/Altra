...
<div class="l-outline">
  ...
  <header class="js-header not-prose sticky left-0 top-0 w-full z-40 transform transition-all duration-500 header-visual-styles" data-behavior-when-scrolling-down="<?php the_field('header_behavior_when_scrolling_down', 'option'); ?>">
    <div class="l-wrap">
      <div class="flex justify-between items-center">
        <a class="block w-40 flex-1 text-header font-bold text-16 lg:text-25 hover:no-underline hover:text-header" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_html_e( 'Go to homepage', 'edgeempower' ); ?>">
          EDGEEMPOWER
        </a>
