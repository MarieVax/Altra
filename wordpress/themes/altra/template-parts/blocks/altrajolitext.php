      ...
      <div class="content-wrapper">
        ...
        ?>
          <ul class="lines">
            ...
            ?>
              <li class="line">
                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/tick-before.svg'; ?>" class=" altra--services-item-icone-1 altra--services-item-icone" alt="">
                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/tick-round.svg'; ?>" class="altra--services-item-icone-2 altra--services-item-icone" alt="">
                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/tick-down.svg'; ?>" class="altra--services-item-icone-3 altra--services-item-icone" alt="">
                <?php // Title
