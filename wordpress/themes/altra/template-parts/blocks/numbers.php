  ...
  <div class="numbers-container">
    <div class="flex numbers">
      <div class="flex-1 text-center numbers-col numbers-col1">
        ...
        <div class="relative numbers-col-item">
      ...
      <div class="flex-1 text-center numbers-col numbers-col2">
        ...
        <div class="numbers-col-item">
          ...
          if ($money_retrieved = get_field('money_retrieved')) :
            printf('<div class="numbers--money_retrieved numbers-col-item--heading"><div class="numbers--money_retrieved-100">100</div><div class="numbers--money_retrieved-200">200</div>%s</div>', $money_retrieved);
          endif;
