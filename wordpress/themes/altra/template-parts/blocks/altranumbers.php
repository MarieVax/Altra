        ...
        ?>
          <div class="numbers-content">
            ...
            while (have_rows('numbers')) :
              ...
              $right = !$right;
            ?>
              <article class="number-block number-block-<?php echo $count; ?> <?php echo $position; ?>">

                <div class="number-wrapper <?php echo $position; ?> relative">
                  <?php if ($count == 1) :
                    echo '<div class="numbers--money_retrieved-100 numbers--money_retrieved Money">+100</div><div class="numbers--money_retrieved-200 numbers--money_retrieved Money">+200</div>';
                  endif; ?>
                  <?php // Number
                  ...
                  echo '<div class="relative numbers--years_experience-img">
