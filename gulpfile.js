...
try {
  ...
  var templateNameWP = 'edgeempower';
}
...
// Compile styles
function styles() {
  return src(['src-assets/sass-global/main.sass', 'src-assets/sass-global/fonts.sass'])
...
function stylesAdminGlobal() {
  return src(['src-assets/sass-global/admin-global.sass', 'src-assets/sass-global/editor-styles.sass'])
    .pipe(sassGlob())
...
function watchSource() {
  ...
  watch(['src-assets/sass-separate-files/**/*.+(sass|scss)', 'src-assets/sass-global/fonts.sass'], series(styles_separate));
  watch(['src-static/**/*.html'], series(html));
  watch(['wordpress/themes/edgeempower/**/*.php', 'src-static/**/*.html'], series(styles, reloadBrowser));
